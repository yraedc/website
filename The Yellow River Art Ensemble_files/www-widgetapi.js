...
b.prototype.A=function(h,g){if(this.h!=0)throw Error("Cannot settle("+h+", "+g+"): Promise already settled in state"+this.h);this.h=h;this.i=g;this.h===2&&this.L();this.T()};
...
b.prototype.T=function(){if(this.g!=null){for(var h=0;h<this.g.length;++h)e.h(this.g[h]);this.g=null}};
...
function Cb(a){Hb(a,a.id,String(Y(a,"host")));a.h=setInterval(a.F.bind(a),250);a.g&&(a.o=function(){clearInterval(a.h);a.h=setInterval(a.F.bind(a),250)},a.g.addEventListener("load",a.o))}
